...
export default function Timeline ({ data }: { data: TimelineEntry[] }) {
  ...
  return (
    <div
      className="bg-transparent my-10 font-sans md:px-10 w-full"
      ref={containerRef}
    >
      <div className="w-[85%] mx-auto py-10 px-4 md:px-8 lg:px-10">
      ...
      <div ref={ref} className="relative w-[85%] mx-auto pb-20">
        {data.map((item, index) => (
          <div
            key={index}
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="ml-[0.85rem] h-4 absolute left-3 md:left-3 w-4 rounded-full bg-white dark:bg-black flex items-center justify-center">
