...
export default function Timeline({ data }: { data: TimelineEntry[] }) {
  ...
  return (
    <div
      className='my-10 w-full bg-transparent font-sans md:px-10'
      ref={containerRef}
    >
      <div className='mx-auto w-[85%] px-4 py-10 md:px-8 lg:px-10'>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className='sticky top-40 z-40 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm'>
              <div className='absolute left-3 ml-[0.85rem] flex h-4 w-4 items-center justify-center rounded-full bg-white dark:bg-black md:left-3'>
                <div className='h-2 w-2 rounded-full border border-neutral-300 bg-neutral-200 p-2 dark:border-neutral-700 dark:bg-neutral-800' />
              </div>
